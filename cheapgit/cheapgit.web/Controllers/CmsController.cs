namespace cheapgit.web.Controllers
{
    ...
    public class CmsController : Controller
    {
            ...
            Guid? category = null, Guid? tag = null, bool draft = false)
        {
            try
            {
                var model = await _loader.GetPageAsync<Models.Pages.StandardArchive>(id, HttpContext.User, draft);
        ...
        public async Task<IActionResult> Post(Guid id, bool draft = false)
        {
            try
            {
                var model = await _loader.GetPostAsync<Models.Posts.StandardPost>(id, HttpContext.User, draft);
        ...
        public async Task<IActionResult> SavePostComment(SaveCommentModel commentModel)
        {
            try
            {
                var model = await _loader.GetPostAsync<Models.Posts.StandardPost>(commentModel.Id, HttpContext.User);
